...
function USPresidentialElection2016_respondentsddd() {
  var data = google.visualization.arrayToDataTable([
    ['Participants', 'Count'],
    ['UNLV',     70],
    ['Web',      35],
  ...
  var chart = new google.visualization.PieChart(document.getElementById('USPresidentialElection2016_respondentsddd'));
  chart.draw(data, options);
}
//////////////////////////////////////////////
