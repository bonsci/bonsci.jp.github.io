...
(function() {
  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      var max_amount;
      this.data = data;
      this.width = (window.innerWidth > 0) ? 0.77*window.innerWidth : 0.77*screen.width;
      this.height = 300;
      ...
      this.force = null;
      this.circles = null;
      this.fill_color = d3.scale.ordinal().domain(["1", "2", "3"]).range(["#0066ff", "#d41243", "#beccae"]);
    ...
    BubbleChart.prototype.create_nodes = function() {
      this.data.forEach((function(_this) {
        return function(d) {
          ...
          node = {
            id: d.id,
            radius: _this.radius_scale(0.1*parseInt(d.count)),
            value: d.count,
            name: d.tweet,
            group: d.group,
            year: d.group,
...
//				      content += "<span class=\"name\">Group:</span><span class=\"value\"> " + data.group + "</span>";
  ...
  $(function() {
    ...
    return d3.csv("bubblechart_en-1-1_tri.csv", render_vis);
  });
