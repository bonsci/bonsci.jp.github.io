...
(function() {
  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      this.force = null;
      this.circles = null;
      this.fill_color = d3.scale.ordinal().domain(["1", "2", "3"]).range(["#e41a1c", "#377eb8", "#beccae"]);
    ...
    BubbleChart.prototype.create_nodes = function() {
      this.data.forEach((function(_this) {
        return function(d) {
          ...
          node = {
            id: d.id,
            radius: _this.radius_scale(0.1*parseInt(d.total_amount)),
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      content = "<span class=\"name\">Answer:</span><span class=\"value\"> " + data.name + "</span><br/>";
  ...
  $(function() {
    ...
    return d3.csv("<?php echo base_url(); ?>visualization/bubblechart/data/testdata.csv", render_vis);
  });
